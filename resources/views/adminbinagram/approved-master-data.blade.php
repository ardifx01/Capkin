...
@section('title', 'Approved Master Data - Admin Binagram')
    ...
    <div class="w-full p-5 h-full">
        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg p-4 bg-white mt-3">
            <div class="w-full flex justify-between">
                <div class="bg-white">
                    <form action="{{ route('search-data-approved-ab') }}" method="GET"
                        ...
                        <tr class="bg-white border-b hover:bg-gray-50">
                            ...
                            <td class="py-4 px-6 text-left whitespace-nowrap">
                                @if (isset($data->approved_by))
                                    ...
                                    <span
                                        class="text-blue-600">{{ $data->approved_by->bidang->nama_bidang ?? 'N/A' }}</span>
                                @else
